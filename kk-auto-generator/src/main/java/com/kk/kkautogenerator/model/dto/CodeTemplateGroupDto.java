 ...
 */
@Data
@ApiModel(value = "代码模板分组详情返回实体", description = "代码模板分组")
public class CodeTemplateGroupDto implements Serializable {
    ...
    */
    ...
    @ApiModelProperty("模板分组明细列表")
    private List<CodeTemplateGroupSubListDto> codeTemplateGroupSubList;
